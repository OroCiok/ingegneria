 ...
 * @author ionbaltaga
 */
public class InventarioMagazzinoView extends JFrame {
    ...
    InventarioMagazzinoView() {
        container.setLayout(new BorderLayout());
        setTitle("Inventario magazzino");
        label_seleziona_ingresso = new Label("Ecco gli articoli disponibili in magazzino");
        ...
        String columarticoli[] = {"Articolo", "Quantità"};
